  ...
  return (
    <div className="flex flex-row sm:flex-row w-full items-center gap-3 md:gap-2 lg:gap-3  bg-[#f6f9fd] rounded-[5px] p-[4%]">
      ...
      {/* w-16 h-16 sm:w-[75px] sm:h-[75px]  md:w-[86px] md:h-[86px] lg:w-24 lg:h-24 */}
        <div className="relative    w-[35%] sm:w-[20%] md:w-[35%]  aspect-square">
          <Image
      ...
      <div className="flex lg:flex-row md:flex-col sm:flex-row  w-[75%] md:w-[50%] lg:w-[75%] justify-between items-center gap-2">
        <div className="flex flex-col  gap-2 sm:gap-3  md:gap-0 lg:gap-4  w-[50%] md:w-[100%] lg:w-[50%] ">
      ...
      {/* </Link> */}
      <div className="w-[45%] md:w-[100%] lg:w-[50%] ">
        {isFollowed && isFollowed?.status === "pending" ? (
          ...
          <div
            ...
            className=" w-full flex  justify-center  items-center gap-0.5 sm:gap-1 md:gap-2 rounded-full px-2 sm:px-4 md:px-8 lg:px-12 py-0.5 sm:py-1 md:py-0.5 lg:py-2 border border-primary cursor-pointer "
          >
            <div className=" ">
