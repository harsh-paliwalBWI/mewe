            ...
            <div className='flex py-6 justify-center items-center  md:h-[100vh] h-auto'>
                ...
                <div className='md:w-[45%] sm:w-[70%] w-[100%]  xl:px-20 md:px-10 px-5 md:mt-0 mt-16 '>
                  ...
                  <div className='flex flex-col gap-5 my-12'>
                    <Link href={"/signup"}>
                   <div className=' border border-primary text-primary flex justify-center items-center py-3 rounded-full lg:text-lg sm:text-base text-xs font-semibold w-[85%] mx-auto cursor-pointer'><button className=''>Log In</button></div>
                   </Link>
                   <Link href={"/signup"}>
                    <div className='bg-primary text-white flex justify-center items-center py-3 rounded-full lg:text-lg sm:text-base text-xs font-semibold w-[85%] mx-auto cursor-pointer '><button className=''>Sign Up</button></div>
                    </Link>
                    </div>
                    <div className='text-center lg:text-lg sm:text-base text-sm text-[#383838] font-medium  mb-8'><h2>or Sign In with</h2></div>
