    ...
    <>
      <div className='flex py-6 justify-center '>
        ...
        <div className='md:w-[43%] sm:w-[70%] w-[100%]  xl:px-20 md:px-10 px-5'>
          <div className='flex justify-center items-center xl:text-3xl md:text-2xl text-xl font-bold sm:my-32 my-16 tracking-widest'><h1>Sign up to <span className='text-primary font-bold'>ME WE</span></h1></div>
          <div className='flex flex-col gap-14'>
            <div className="border border-[#868E97] relative ">
              <label className="block  text-sm  absolute top-[-10px] left-[10px] text-[#868E97] px-1  bg-white font-medium tracking-widest" htmlFor="input">Name</label>
              <input className="rounded-lg px-3 py-4 w-full outline-0" type="text" id="input" />
            </div>
            <div className="border border-[#868E97] relative ">
              <label className="block text-sm text-[#868E97]   absolute top-[-10px] left-[10px] px-1 font-medium bg-white tracking-widest" htmlFor="input">Email or Phone Number</label>
              <input className="rounded-lg px-3 py-4 w-full outline-0" type="text" id="input" />
            </div>
          </div>
