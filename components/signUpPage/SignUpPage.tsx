        ...
        <div className="md:w-[45%] sm:w-[70%] w-[100%]  xl:px-20 md:px-10 px-5">
          <div className=" flex flex-col gap-10">
            <div className="flex justify-center items-center lg:text-4xl sm:text-2xl text-xl font-bold md:mt-0 mt-10 ">
              <h1>
                Sign up to <span className="text-primary font-bold">MEWE</span>
              </h1>
            </div>
            <div>
              <div className="flex flex-col md:gap-10 gap-7 sm:mt-5">
                <div className="border border-[#868E97] relative ">
                  <label
                    className="block  text-sm  absolute top-[-10px] left-[10px] text-[#868E97] px-1  bg-white font-medium "
                    htmlFor="input"
                  >
                    Name
                  </label>
                  <input
                    className="rounded-lg px-3 lg:py-4 py-3 w-full outline-0"
                    type="text"
                    id="input"
                  />
                </div>
                <div className="border border-[#868E97] relative ">
                  <label
                    className="block text-sm text-[#868E97]   absolute top-[-10px] left-[10px] px-1 font-medium bg-white "
                    htmlFor="input"
                  >
              ...
              <div className="flex mt-[20px]  flex-grow sm:flex-row flex-col sm:gap-0 gap-5  justify-between   md:items-center font-bold sm:text-sm text-sm">
                <div className="flex start gap-2">
                  ...
                  <div className="sm:text-sm text-xs w-fit text-gray-600  font-semibold">
            ...
            <Link href={"/signin"}>
              <div className="bg-primary text-white flex justify-center items-center py-4 rounded-lg lg:text-base sm:text-sm text-xs  cursor-pointer font-medium">
