        ...
        <>
            <div className='flex py-6 justify-center '>
                ...
                <div className='md:w-[43%] sm:w-[70%] w-[100%]  xl:px-20 md:px-10 px-5'>
                    ...
                    <div className='text-primary font-bold flex justify-center items-center xl:text-2xl lg '><h1>Enter the verification code</h1></div>
                    <div className='flex justify-center items-center text-center text-[#868E97] font-semibold xl:text-sm text-xs mt-4  mb-14'><h3>We will be sending a verification code to the provided <br />contact number.</h3></div>
