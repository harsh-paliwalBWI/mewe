...
const BusinessAccount = () => {
  ...
  return (
    <div className='  h-fit py-2 md:w-[63%] w-[100%] relative z-0 mb-10'>
      ...
      <div className="w-full flex flex-col gap-9 my-10 ">
        <div className="flex sm:flex-row flex-col md:gap-x-9 gap-x-5 gap-y-9 w-full ">
        ...
        <div className="flex sm:flex-row flex-col md:gap-x-9 gap-x-5 gap-y-9 w-full relative  ">
      ...
      <div>
        ...
        <div className='w-full  my-10'>
          <div className="grid sm:grid-cols-2  grid-cols-1 md:gap-x-9 gap-x-5 gap-y-9  w-full  ">
              ...
              <div>
                ...
                <div className='flex flex-col gap-3  '>
                  <div className='flex justify-between items-center'>
                    <div className='text-sm text-[#868E97] font-medium '>Quarter 1 (Jan- Mar)</div>
                    <div className='px-6 py-3 border border-[#C8C8C8] rounded-md text-xl text-[#9bb7d3]'>&#8377;</div>
                  </div>
                  <div className='flex justify-between items-center'>
            ...
            <div>
              ...
              <div className='text-center text-[#868e97] flex justify-center text-sm border border-primary rounded-md py-3 mt-4'><button className='flex items-center justify-center gap-1'><FlatIcon className="flaticon-plus text-[10px]" /> <span>Add product</span></button></div>
            </div>
          </div>
          <div className='grid lg:grid-cols-2 grid-cols-1 sm:grid-cols-2  md:gap-9 gap-5  w-full  mt-12'>
            <div className='flex flex-col gap-9'>
              <div className='border border-[#C8C8C8]  relative flex items-center rounded-md '>
