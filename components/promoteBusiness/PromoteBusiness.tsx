        ...
        <div className="px-body  ">
          ...
          <div className="flex justify-center items-center gap-3 ">
            ...
            <div
              ...
              className={`sm:w-[58px] w-[48px] flex items-center px-1 sm:h-[29px] h-[19px] ${
            ...
            <>
              ...
              >
                  ...
                  <div className="bg-[#fffdf3] py-5 px-5">
                    ...
                    <div className="text-center bg-[#A6D6BF] py-3  mt-5 font-bold xl:text-base text-sm">
              ...
              >
                  ...
                  <div className="bg-[#fffdf3] py-5 px-5">
                    ...
                    <div className="flex items-end">
                      <h2 className="xl:text-xl font-bold text-lg">
                        Rs. 1,999/
                      </h2>
                      <p className="text-[#a1a099] text-xs font-semibold">
                        year
                    ...
                    <div className="text-center bg-[#4B647E] py-3 text-white font-bold xl:text-base text-sm mt-5">
                      <button>Get Started!</button>
                    </div>
                  </div>
                </div>
              ...
              >
                  ...
                  <div className="bg-[#fffdf3] py-5 px-5">
                    ...
                    <div className="text-center bg-[#9BC1F9] py-3  mt-5 font-bold xl:text-base text-sm">
                      <button>Get Started!</button>
                    </div>
                  </div>
                </div>
