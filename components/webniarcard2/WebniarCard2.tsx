...
const WebniarCard2 = () => {
  return (
    // flex-col lg:
    <div className="  flex flex-row justify-between gap-1 sm:gap-2 md:gap-3 mt-12 sm:mt-16 md:mt-20 bg-[#f2fff3]">
      {/* w-full lg: */}
      ...
      <div className=" w-full lg:w-[65%]  pt-1 sm:pt-3 md:pt-5 pb-0.5 sm:pb-1 md:pb-2 pr-1 sm:pr-3 md:pr-5 ">
        <div className="  flex flex-col h-full gap-1 sm:gap-2 md:gap-3 justify-between ">
          <div className="  flex flex-col gap-1 sm:gap-2 md:gap-3  justify-between ">
            <div className="flex justify-between gap-1 sm:gap-2 md:gap-3 items-start">
              ...
              <FlatIcon className="flaticon-heart md:text-3xl sm:text-2xl text-xl font-bold " />
            </div>
